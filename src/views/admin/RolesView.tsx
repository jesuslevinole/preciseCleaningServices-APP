...
export default function App() {
  ...
  // --- LIMPIEZA: Inicializamos las propiedades (casas) completamente vacías ---
  ...
  // --- LIMPIEZA: Inicializamos los roles completamente vacíos ---
  const [roles, setRoles] = useState<Role[]>([]);
  const [simulationRole, setSimulationRole] = useState<string | null>(null);

  // Ajuste para que no busque el rol "r1" de prueba
